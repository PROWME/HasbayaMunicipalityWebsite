...
export default function ProjectsForm({ onSuccess }: ProjectsFormProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      await axios.post("/api/projects/createProjects", formData, {
        headers: {
      ...
      toast.success(t("admin.projectsSuccess"));
      setTitleAr("");
      setTitleEn("");
      setDescAr("");
      setDescEn("");
      ...
      console.error(err);
      toast.error(t("admin.projectsError"));
    } finally {
