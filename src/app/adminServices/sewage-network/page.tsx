...
const SewageNetwork = () => {
  ...
  const [surveyMap, setSurveyMap] = useState<File[]>([]);
  const [networkDiagram, setNetworkDiagram] = useState<File[]>([]);
  ...
  const validateForm = () => {
    ...
    if (surveyMap.length === 0) {
      newErrors.surveyMap = true;
    }

    if (networkDiagram.length === 0) {
      newErrors.networkDiagram = true;
    }
  ...
  const handleSubmit = async () => {
    ...
    surveyMap.forEach((file) => data.append("surveyMap", file));
    networkDiagram.forEach((file) => data.append("networkDiagram", file));
      ...
      <div className="w-11/12 mx-auto py-10">
        ...
        <div className="flex flex-col border-b border-gray-400">
          ...
          <DocumentUploader
            ...
            surveyMap={surveyMap}
            setSurveyMap={setSurveyMap}
            networkDiagram={networkDiagram}
            setNetworkDiagram={setNetworkDiagram}
