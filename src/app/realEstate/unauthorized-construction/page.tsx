...
const UnauthorizedConstruction = () => {
  ...
  const [violationProof, setViolationProof] = useState<File[]>([]);
  ...
  const validateForm = () => {
    ...
    if (violationProof.length === 0) {
      newErrors.violationProof = true;
    }
  ...
  const handleSubmit = async () => {
    ...
    violationProof.forEach((file) => data.append("violationProof", file));
      ...
      <div className="w-11/12 mx-auto py-10">
        ...
        <div className="flex flex-col border-b border-gray-400">
          ...
          <DocumentUploader
            ...
            setViolationProof={setViolationProof}
...
export default UnauthorizedConstruction;
